...
def decodePacket(message):
	...
	if packettype == '51':
		...
		if cmdarg.printout_complete == True:
			...
			print "Humidity Status\t\t= " + rfx.rfx_subtype_51_humstatus[humidity_status]
			print "Battery\t\t\t= " + str(battery)
			print "Signal level\t\t= " + str(signal)
		...
		# XPL
		if cmdarg.xpl == True:
			xpllib.send('device=thgr228.'+signal_id+'\ntype=temp\ncurrent='+temperature+'\nunits=C')
	...
	if packettype == '52':
		...
		if cmdarg.printout_complete == True:
			...
			print "Humidity Status\t\t= " + rfx.rfx_subtype_52_humstatus[humidity_status]
			print "Battery\t\t\t= " + str(battery)
			print "Signal level\t\t= " + str(signal)
...
def main():
	...
	if options.xpl:
		...
		print "Option: XPL |"+cmdarg.printout_xpl+"|"
